...
public enum DayFixture {
    ...
    public static var day: Date {
        calendar.dayInterval(for: Date(timeIntervalSince1970: 1_700_000_000)).start
    }

    public static func moment(hour: Int, minute: Int = 0, dayOffset: Int = 0) -> Date {
    ...
    public static func drink(_ milliliters: Int, at hour: Int, dayOffset: Int = 0) -> DrinkEntry {
        DrinkEntry(
            id: UUID(),
